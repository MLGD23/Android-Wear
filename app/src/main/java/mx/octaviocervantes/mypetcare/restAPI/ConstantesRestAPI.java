...
public final class ConstantesRestAPI{
	...
	public static final String FOLLOW_ACTION = "&action={action}";
	...
	public static final String FOLLOW_USER = "users/{user-id}/relationship";
	...
	public static final String URL_FOLLOW_USER = FOLLOW_USER + KEY_ACCESS_TOKEN;
	public static final String URL_RELATIONSHIP = FOLLOW_USER + KEY_ACCESS_TOKEN;
}